...
Currently EmJi Ai supports the following payment gateways:

- [Stripe](https://stripe.com/)
- [PayPal](https://www.paypal.com/)
- [Razorpay](https://razorpay.com/)

We will guide you through the process of integrating these payment gateways into your EmJi Ai application.
