        ...
        <div className="hidden sm:block">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-end sm:ps-7">
            {/* <Link
              ...
              className="flex items-center gap-x-2 font-medium text-gray-500 transition-colors duration-300 hover:text-[#423042] py-2 sm:py-0 sm:ms-4 sm:my-6 sm:ps-6 dark:text-neutral-400 dark:hover:text-primary"
            >
              <BookText size={16} />
            ...
            <Link
              href=""
              className="flex items-center gap-x-2 font-medium text-gray-500 transition-colors duration-300 hover:text-[#423042] sm:border-s sm:border-gray-300 py-2 sm:py-0 sm:ms-4 sm:my-6 sm:ps-6 dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-primary"
            >
              <svg
              ...
              >
                <div className="p-5">
                  ...
                  <div className="flex flex-col space-y-6">
                    {/* <Link
                      href="/documentation/intro"
                      className="flex items-center gap-x-2 font-medium text-gray-700 hover:text-[#423042] dark:text-neutral-300"
                      onClick={toggleMenu}
                    >
                      <BookText size={16} />
                      <div>Documentation</div>
