  ...
  return (
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div className="mt-12 grid sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-neutral-800">
          ...
          <ul className="mt-7 space-y-2.5 text-sm">
            <li className="flex gap-x-2">
              <svg
                className="shrink-0 mt-0.5 size-4 text-[#423042] dark:text-[#865db2]"
        ...
        {/* <!-- Card --> */}
        <div className="flex flex-col border-2 border-[#423042] text-center shadow-xl rounded-xl p-8 dark:border-[#865db2]">
          <p className="mb-3">
            <span className="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-lg text-xs uppercase font-semibold bg-[#423042]/10 text-[#423042] dark:bg-[#865db2] dark:text-white">
              Most popular
            </span>
          </p>
          <h4 className="font-medium text-lg text-gray-800 dark:text-neutral-200">
          ...
          <a
            className="mt-5 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#423042] text-white hover:bg-[#865db2] focus:outline-none focus:bg-[#865db2] disabled:opacity-50 disabled:pointer-events-none"
            href="/dashboard"
          >
            Sign up
          </a>
