  ...
  const sections = [
    {
      ...
      content: `At EmJi Ai, we use cookies and similar technologies to provide you with the best possible experience. This policy explains how we use these technologies and the choices you have.`,
    },
    {
...
• Maintain your session and preferences while using EmJi Ai
...
Performance Cookies: Help us understand how users interact with EmJi Ai.
...
Please note that limiting cookies may affect some features of EmJi Ai, particularly those related to AI tutor personalization.`,
    },
    {
