...
const TextDisplay: React.FC<TextDisplayProps> = ({ isActive, onSelect }) => {
  return (
    <div className={`bg-white rounded-lg shadow-md overflow-hidden ${isActive ? 'ring-2 ring-blue-500' : ''}`}>
      ...
      <div className="flex flex-col items-center justify-center h-96 p-8">
        ...
        <p className="text-gray-600 text-center mb-4">
          Text content display is currently under development. Check back soon for enhanced text-based learning materials.
        </p>
